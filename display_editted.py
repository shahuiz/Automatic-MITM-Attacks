...
#### Register variables  
    ...
    for ri in range(total_round):
        for i in ROW:
            for j in COL:
                M_x[ri, i, j] = S_x[ri, i, (j + i)%NCOL]
                M_y[ri, i, j] = S_y[ri, i, (j + i)%NCOL]
